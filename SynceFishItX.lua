...
do
    ...
    local blatant = farm:Section({ Title = "Blatant Mode", TextSize = 18, })
...
do
   ...
   -- =================================================================
    ...
    local favsec = automatic:Section({ Title = "Auto Favorite / Unfavorite", TextSize = 18, })
...
local function GetItemsToFavorite()
    ...
    local enchant = automatic:Section({ Title = "Auto Enchant Rod", TextSize = 18,})
...
do
    ...
    local weathershop = shop:Section({ Title = "Auto Buy Weather", TextSize = 18, })
    ...
    -- Rods, Bobbers, Boats
    local prod = shop:Section({ Title = "Purchase Rods", TextSize = 18, })
    shop:Divider()
    ...
    local pbait = shop:Section({ Title = "Purchase Bobbers", TextSize = 18, })
    shop:Divider()
    ...
    local pboat = shop:Section({ Title = "Purchase Boats", TextSize = 18, })
    shop:Divider()
    ...
    local ptele = shop:Section({ Title = "Shop Teleports", TextSize = 18, })
    shop:Divider()
...
-- =================================================================
local backpack = utility:Section({ Title = "Backpack Scanner", TextSize = 18, })
