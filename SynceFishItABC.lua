...
local SynceHubConfig = Window.ConfigManager:CreateConfig("Syncehub")
...
do
    ...
    _G.SynceHub_AutoAcceptTradeEnabled = false 
    ...
    if PromptController and PromptController.FirePrompt and Promise then
        ...
        warn("[SynceHub] Gagal memuat PromptController/Promise untuk Auto Accept Trade.")
    end
end
...
do
    ...
    local blatant = farm:Section({ Title = "Blatant Mode", TextSize = 17, })
...
do
   ...
   -- =================================================================
    ...
    local favsec = automatic:Section({ Title = "Auto Favorite / Unfavorite", TextSize = 17, })
...
local function GetItemsToFavorite()
    ...
    local accept = trade:Toggle({
        ...
        Value = false,
        Callback = function(state)
            _G.SynceHub_AutoAcceptTradeEnabled = state
    ...
    local enchant = automatic:Section({ Title = "Auto Enchant Rod", TextSize = 17,})
...
do
    ...
    local weathershop = shop:Section({ Title = "Auto Buy Weather", TextSize = 17, })
    ...
    -- Rods, Bobbers, Boats
    local prod = shop:Section({ Title = "Purchase Rods", TextSize = 17, })
    shop:Divider()
    ...
    local pbait = shop:Section({ Title = "Purchase Bobbers", TextSize = 17, })
    shop:Divider()
    ...
    local pboat = shop:Section({ Title = "Purchase Boats", TextSize = 17, })
    shop:Divider()
    ...
    local ptele = shop:Section({ Title = "Shop Teleports", TextSize = 17, })
    shop:Divider()
...
do
    ...
    -- =================================================================
    Event:Divider()
    local disco = Event:Section({ Title = "Disco Event", TextSize = 17,})
...
-- =================================================================
local backpack = utility:Section({ Title = "Backpack Scanner", TextSize = 17, })
...
do
    ...
    local SelectedConfigName = "Syncehub" -- Default
    local BaseFolder = "WindUI/" .. (Window.Folder or "SynceHub") .. "/config/"
    ...
    ConfigSection:Button({
        ...
        Callback = function()
            ...
            -- 1. Save ke config utama dulu ("Syncehub.json")
            SynceHubConfig:Save()
            task.wait(0.1)

            -- 2. Jika nama beda, salin isi "Syncehub.json" ke "NamaBaru.json"
    ...
    --ConfigSection:Paragraph({
       ...
       -- Desc = "Script otomatis menyimpan ke 'Syncehub.json' setiap 30 detik.",
      --  Icon = "info"
 --   })
end
...
task.spawn(function()
    ...
    -- Default load "Syncehub", atau nama config terakhir user kalau kamu simpan
    SmartLoadConfig("Syncehub") 
    
    -- Auto Save Loop (Setiap 30 detik) -- Save tetap pakai cara biasa gapapa
    while true do
         task.wait(10)
         pcall(function() SynceHubConfig:Save() end)
    end
end)
InitializeIcon()