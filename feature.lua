-- SynceHub - Features Module (FIXED VERSION)
-- Berisi semua fungsi helper dan utilities

-- ✅ FIX #1: Pisahkan WindUI dan Window dengan benar
...
print("[SynceHub Features] 🔄 Initializing features module...")
...
pcall(function()
    ...
    for i, v in pairs(getconnections(player.Idled)) do
        if v.Disable then
            v:Disable()
            print("[SynceHub Anti-AFK] ✅ Enabled")
        end
    end
end)
...
print("[SynceHub Features] ✅ Features Module Loaded Successfully!")
print("[SynceHub Features] - Total Fishing Areas: " .. #_G.SynceHub.AreaNames)
print("[SynceHub Features] - Utility Functions: Ready")
print("[SynceHub Features] - Config System: Ready")